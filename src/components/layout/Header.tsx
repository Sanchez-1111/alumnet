      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {/* Verified Role Badge */}
            {currentUser && (
              <div className="flex items-center gap-1.5 px-2.5 py-1 text-xs font-semibold rounded-lg bg-stone-100 text-stone-800 border border-stone-200">
                          ...
                          {n.type === 'friend_request' && n.refId && (
                            <div className="mt-2.5 flex items-center gap-2">
                              <button
                                ...
                                className="flex items-center gap-1 px-2.5 py-1 text-xs font-semibold text-white bg-blue-600 hover:bg-blue-700 rounded-md shadow-xs transition-colors"
                              >
